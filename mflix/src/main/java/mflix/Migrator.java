...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        ...
        try {
            ...
            if (!imdbRating.isEmpty()) {
                rating = Double.valueOf(imdbRating);
            }
            ...
            return new UpdateOneModel<Document>(new Document("imdb.rating", imdbRating), new Document("$set" , new Document("imdb.rating", (int) rating)));
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = new String("mongodb+srv://m220student:m220password@mflix.dhzht.mongodb.net/myFirstDatabase?retryWrites=true&w=majority&readConcernLevel=majority");
        ...
        Bson dateStringFilter = new Document("lastupdated", new Document("$type", "string"));
        ...
        // format pattern
        // Document queryFilter = new Document("date", new Document("$type", "string"));
        ...
        Bson ratingStringFilter = new Document("imdb.rating", new Document("$type", "string"));
