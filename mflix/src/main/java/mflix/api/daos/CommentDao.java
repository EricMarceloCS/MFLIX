...
public class CommentDao extends AbstractMFlixDao {
    ...
    public Comment addComment(Comment comment) {
    	...
    	if(comment.getId() == null)
    		throw new IncorrectDaoOperation("Missing ID");
    	
    	commentCollection.insertOne(comment);
        // TODO> Ticket - Handling Errors: Implement a try catch block to
        // handle a potential write exception when given a wrong commentId.
    	comment = commentCollection.find(new Document("_id", comment.getOid())).first();
        return comment;
    }
    ...
    public boolean updateComment(String commentId, String text, String email) {
    	...
    	Comment comment = commentCollection.find(new Document("_id", id).append("email",email)).first();
    	if(comment == null)
    		return false;
    	
    	Bson bson = new Document("text", text);
    	
    	commentCollection.updateOne(new Document("_id", id), new Document("$set", bson));
        // TODO> Ticket - Handling Errors: Implement a try catch block to
        // handle a potential write exception when given a wrong commentId.
        return true;
    }
    ...
    public boolean deleteComment(String commentId, String email) {
    	...
    	try {
        	...
        	commentCollection.findOneAndDelete(new Document("_id", id).append("email", email));
    ...
    public List<Critic> mostActiveCommenters() {
        ...
        MongoCollection<Document> criticCollection = this.db.getCollection(COMMENT_COLLECTION);
        MongoCursor<Document> iterator = criticCollection.aggregate(aggregationPipeline).iterator();
                
        //Create Critic instances and add them to the mostActive List<Critic>
